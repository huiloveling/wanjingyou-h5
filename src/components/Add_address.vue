<template>
    <div class="edit_address">
        ...
        <ul class="edit_detail">
            ...
            <li>
                <span>联系电话：</span>
                <input type="text" maxlength="11" placeholder="收货人联系电话" v-model="user_info.userphone">
            </li>
            <li>
                <span>所在地区：</span>
...
export default {
    ...
    methods: {
        ...
        save_address(){
            ...
            const url = `${api}userAddress/insertAddress`;
            if(this.address_checked==true){
                this.p_address_checked = 1;
            }else{
                this.p_address_checked = 0;
            }
            const params = Object.assign({}, commonParams(true), {
                ...
                isDefault:this.p_address_checked,
...
.edit_address >>>.van-nav-bar
    z-index 999
    margin-bottom 10px
.edit_address >>>[class*=van-hairline]::after
    border-color #d1d1d0
.edit_address
    height 100vh
    width 100vw
